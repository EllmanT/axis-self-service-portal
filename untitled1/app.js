...
const allowedOrigins = ['http://localhost:4200', 'https://yourfrontenddomain.com','https://fiscalcloud.co.zw','https://app.fiscalcloud.co.zw','https://staging.fiscalcloud.co.zw', 'https://gcp-certification-pxdyos.web.app', 'https://gcp-certification-415402.web.app'];
app.use(cors({
...
app.use('/api/docs-ai', virtualFiscalisation)
