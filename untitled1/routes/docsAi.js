...
//start of the company verifier ai
/* GET users listing. */
router.post("/companyVerifier", async function (req, res) {
    let invoiceStructuredData = {};
    const data = req.body;
    /**
     * TODO(developer): Uncomment these variables before running the sample.
    ...
    const projectId = "856756161616";
    const location = "us"; // Format is 'us' or 'eu'
    const processorId = "97ab9c8824b51dbb"; //'825299c583757a10'; // Create processor in Cloud Console
